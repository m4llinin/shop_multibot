...
async def my_profile(message: Message, state: FSMContext):
    ...
    user = await Database.ShopBot.get_user(message.chat.id)
    partner_balance = await Database.ShopBot.get_partner_balance(user.id)
    total_orders = await Database.ShopBot.get_total_orders(user.id)
